...
This project shows a seasonal information determining if its either sunny or chilly outside based on users geolocation and current month. 

Below you will find some information on how to perform common tasks on react projects.<br>
